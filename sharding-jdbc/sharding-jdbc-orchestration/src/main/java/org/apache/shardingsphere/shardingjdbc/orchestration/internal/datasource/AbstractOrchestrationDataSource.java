...
public abstract class AbstractOrchestrationDataSource extends AbstractUnsupportedOperationDataSource implements AutoCloseable{
    ...
    /**
     * 保存所有的数据源配置
     * properties/yaml -> DataSource -> DataSourceConfiguration -> YamlDataSourceConfiguration
     *
     */
    @Getter(AccessLevel.PROTECTED)
     ...
     *
     * @param circuitStateChangedEvent
     *            circuit state changed event
     */
    @Subscribe
    ...
    protected final void initShardingOrchestrationFacade(final Map<String, Map<String, DataSourceConfiguration>> dataSourceConfigurations,final Map<String, RuleConfiguration> schemaRuleMap,final Properties props){
